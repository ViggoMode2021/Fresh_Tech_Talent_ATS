...
def lambda_handler(event, context):
    ...
    if event:
        ...
        if 'ReactJS' in resume_info_extraction_string:
            print('Yes React')
            React_experience = 'Skill - React'
        if 'React' in resume_info_extraction_string:
            React_experience = 'Skill - React'
        if 'React.js' in resume_info_extraction_string:
            React_experience = 'Skill - React'
        if 'ReactJS' or 'React' or 'React.js' not in resume_info_extraction_string:
            print('NO REACT')
        ...
        if 'React' in resume_info_extraction_string and 'Coding bootcamp' or 'Coding Bootcamp' in resume_info_extraction_string and zip_code in tampa_zip_codes:
            email_message = f'Congratulations, {name} you are chosen to interview for the React Developer position! This is regarding your application on {dt_email}.'
